...
public class QuizDbHelper extends SQLiteOpenHelper {
   ...
   /* public void nameOfTable(String nameOfTable){
    ...
    private void fillQuestionTableForYordanYovkov(){
        ...
        Question q19 = new Question("Как е изграден разказът \"Шибил\"?", "чрез следване на ествествената хронология на събитията", "несвързаните размисли на героя", "чрез спомените на очевидец на събитията", "чрез ретроспрективно композиране на сюжета", 2);
