...
public class QuizDbHelper extends SQLiteOpenHelper {
   ...
   /* public void nameOfTable(String nameOfTable){
    ...
    private void fillQuestionTableForAlekoKonstantinov(){
        ...
        Question q19 = new Question("В кое произведение действието се развива в село в Искърското дефиле?", "\"Чичовци\"", "\"Бай Ганьо\"", "\"Дядо Йоцо гледа\"", "\"На прощаване\"", 3);
    ...
    private void fillQuestionTableForYordanYovkov(){
        ...
        Question q18 = new Question("Как започват разказите от цикъла \"Старопланински легенди\"?", "с портретна характеристика", "с авторова характеристика", "с описание на бита", "с мото", 2);
        addQuestion(q18,"yordanYovkovTable");
        Question q19 = new Question("Как е изграден разказът \"Шибил\"?", "чрез следване на ествествената хронология на събитията", "несвързаните размисли на героя", "чрез спомените на очевидец на събитията", "чрез ретроспрективно композиране на сюжета", 4);
        addQuestion(q19,"yordanYovkovTable");
        Question q20 = new Question("За кой от Йовковите герои любовта е по ценна от живота", "Цветана", "Тиха", "Шакире", "Албена", 3);
        addQuestion(q20,"yordanYovkovTable");
    }
    ...
    private void fillQuestionTableForDimityrDimov(){
        ...
        Question q8 = new Question("В коя от посочените творби се откроява естетиката на реализма?", "\"Тютюн\" на Димитър Димов", "\"Септември\" на Гео Милев", "\"Къщата\" на Атанас Далчев", "\"Две души\" на Пейо Яворов", 1);
        ...
        Question q17 = new Question("Коя опозиция НЕ е характерна за романа \"Тютюн\"?", "патриархално - модерно", "провинция - столица", "бедност - богатство", "делник - празник", 4);
        addQuestion(q17,"dimityrDimovTable");
        Question q18 = new Question("В романа \"Тютюн\" е интерпретиран проблемът за:", "мястото и ролята на твореца в общността", "любовта, която пробужда доброто у човека и го преобразява", "опустошителната сила на страстта и властта", "връзката между човека и природата", 3);
        addQuestion(q18,"dimityrDimovTable");
        Question q19 = new Question("Заглавието на романа \"Тютюн\" се превръща в метафора на:", "патризанските битки за един по-справедлив свят", "промените, които настъпват в България след сгромолясването на аморалния свят на \"Никотиани\"", "борбата на тютюноработниците за социални придобивки", "социалната и нравствена отрова, която руши света и душите на героите", 4);
        addQuestion(q19,"dimityrDimovTable");
        Question q20 = new Question("Посочете НЕВЯРНОТО твърдение:", "Творчеството на Димитър Димов се отличава с остра конфликтност, с интерес към странното и екзотичното", "Романът \"Тютюн\" на Димитър Димов е композиран на две части", "Художественото време в романа обхваща около две години от края на 40те години на XXв.", "Художественото пространство в романа е обширно - обхваща България и Гърция", 3);
        addQuestion(q20,"dimityrDimovTable");
    ...
    private void fillQuestionTableForDimityrTalev(){
        ...
        Question q20 = new Question("Основно смислово ядро в романа \"Железният светилник\" е борбата за:", "освобождение на България" , "освобождение на Макаденоя", "духовна независимост и построяване на нова църква в Преспа", "откриване на светско училище и прогонване на фанариотите", 3);
        addQuestion(q20,"dimityrTalevTable");
    }
