...
public class QuizDbHelper extends SQLiteOpenHelper {
   ...
   /* public void nameOfTable(String nameOfTable){
    ...
    private void fillQuestionTableForGeoMilev(){
        ...
        Question q20 = new Question("Експресионизмът като литературно направление се утвърждава в България: ", "през първото десетилетие на XXв.", "в края на XIXв.", "в средата на XXв.", "през 20те години на XXв.", 4);
